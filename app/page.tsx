...
{/* navbar */}
    ...
    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4 ">
        ...
        <div className="flex items-center space-x-6 rtl:space-x-reverse">
            <a href="https://www.instagram.com/enigmaleb/" className="text-sm mr-4  text-gray-500 dark:text-white hover:underline"><img className='w-8 hover:w-10' src="ig.webp" alt="" /></a>
            <a href="https://www.tiktok.com/@enigmaleb" className="text-sm  text-gray-500 dark:text-white hover:underline"><img className='w-8 hover:w-10' src="tiktok.svg" alt="" /></a>
        </div>
    </div>
</nav>
...
<div className='container mx-auto pt-8 overflow-x-auto'>
    ...
    <div className="px-5 pb-5 mt-6">
            ...
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white text-center">OVERTHINKER</h5>
...
<footer className=" bg-gray-200 rounded-lg shadow dark:bg-gray-900 m-4 mt-20">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://enigmalb.netlify.app/" className="hover:underline">ENIGMA™</a>. All Rights Reserved.</span>
    </div>
</footer>
